...
public class CameraView implements PlatformView,Handler.Callback, FaceDetectListener, CameraCaptures
{
    ...
    private String mHintFitCenter = "Please match the face to the portrait frame";
    private String mHintForward = "Please move forward";
    private String mHintBackward = "A little too close";
