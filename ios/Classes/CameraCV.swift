...
class CameraCV : UIViewController
{
    ...
    var mHintCenter:String = "Please match the face to the portrait frame";
    var mHintForward:String = "Please move forward";
    var mHintBackward:String = "A little too close";
